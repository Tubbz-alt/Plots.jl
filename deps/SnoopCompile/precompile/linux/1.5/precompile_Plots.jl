...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Plots.partialcircle),Int64,Float64,Int64})
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline.is_axis_attribute),Plots.Plot{Plots.PlotlyBackend},Symbol})
